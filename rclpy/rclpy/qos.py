...
class QoSHistoryPolicy(IntEnum):
    RMW_QOS_POLICY_HISTORY_SYSTEM_DEFAULT = 1
    RMW_QOS_POLICY_KEEP_LAST_HISTORY = 2
    RMW_QOS_POLICY_KEEP_ALL_HISTORY = 3


class QoSReliabilityPolicy(IntEnum):
    RMW_QOS_POLICY_RELIABILITY_SYSTEM_DEFAULT = 1
    RMW_QOS_POLICY_RELIABLE = 2
    RMW_QOS_POLICY_BEST_EFFORT = 3


class QoSDurabilityPolicy(IntEnum):
    RMW_QOS_POLICY_DURABILITY_SYSTEM_DEFAULT = 1
    RMW_QOS_POLICY_TRANSIENT_LOCAL_DURABILITY = 2
    RMW_QOS_POLICY_VOLATILE_DURABILITY = 3
