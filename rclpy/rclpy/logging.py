...
class LoggingSeverity(IntEnum):
    ...
    UNSET = _rclpy_logging.RCUTILS_LOG_SEVERITY_UNSET
    DEBUG = _rclpy_logging.RCUTILS_LOG_SEVERITY_DEBUG
    INFO = _rclpy_logging.RCUTILS_LOG_SEVERITY_INFO
    WARN = _rclpy_logging.RCUTILS_LOG_SEVERITY_WARN
    ERROR = _rclpy_logging.RCUTILS_LOG_SEVERITY_ERROR
    FATAL = _rclpy_logging.RCUTILS_LOG_SEVERITY_FATAL
