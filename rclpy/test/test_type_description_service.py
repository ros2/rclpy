...
class TestTypeDescriptionService(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.get_type_description_client: Client[
            GetTypeDescription.Request,
            GetTypeDescription.Response] = self.test_node.create_client(
                GetTypeDescription,
                '/rclpy/test_parameter_service/get_type_description',
