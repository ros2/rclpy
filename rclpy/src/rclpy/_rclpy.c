...
/// Initialize a wait_set
/**
 * Raises RuntimeError if the wait set could not be initialized
 *
 * \param[in] pywait_set Capsule pointing to the wait_set structure
 * \param[in] node_name string name of the node to be created
...
/// Add an entity to the wait_set structure
/**
...
/// Destroy the wait_set structure
/**
...
/// Get list of non-null entities in wait_set
/**
...
static PyMethodDef rclpy_methods[] = {
...

  {
    ...
    "List non null subscriptions in wait_set."
  },
